...
show_top_page = function() {
    ...
    var body = [
        ...
        E_("div", {class: "container", style: "padding-top: 70px; padding-bottom: 20px"},
           E_("div", {class: "row"},
              E_("div", {class: "col-md-12"},
                 E_("p", {}, "SCRW is a public online text chat room service."),
                 E_("h2", {}, "Demo"),
                 E_("ul", {},
                    E_("li", {}, E_("a", {href: "/room/elepaio.html"}, "elepaio room")),
                    E_("li", {}, E_("a", {href: "/archive/elepaio/elepaio_0.html"},
                                    "archive"))),
                 E_("h2", {}, "Join/Create a Room"),
